...
# 🖥️ Linguagem de Programação I | C
...
Neste espaço, documento a construção da minha base algorítmica e lógica de programação utilizando a linguagem **C**. O foco principal desta matéria é a compreensão do paradigma estruturado, entendendo "por baixo dos panos" como os dados são alocados, manipulados e processados pelo computador.
